    ...
    return (
        <div className='md:rounded-xl bg-gray-600 md:m-7 flex-1 p-7'>
            ...
            <div className='mt-7'>
                ...
                <p className='mt-4 text-gray-300 text-xl font-semibold'>Hi! I'm Md.Shams Tabris Suvo, a passionate Full-Stack Developer with expertise in the MERN stack,frondend and React Developer. With a strong foundation in modern web development and an eye for detail, I create elegant, user-friendly web solutions tailored to meet client needs.</p>
