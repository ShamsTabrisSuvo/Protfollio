...
export const testimonials = [
    {
        ...
        para:"Shams is a highly talented website developer! He understands requirements well and creates clean, user-friendly websites. Great work and highly recommended! ",
        img: testimonial1
    },
    {
        name:"Aman Sharma",
        para:"Shams is an excellent website developer! He is skilled, professional, and delivers fast, responsive websites. Highly recommended!",
        img: testimonial2
    },
...
export const timeline = [
    ...
    },
    {
      ...
      subtitle: 'Gazipur Ideal College',
      desc: 'Gazipur,Bangladesh',
    },
    {
      icon: schoolIcon,
      date: '2017',
      title: 'Madhyamik (10th)',
      subtitle: 'Rani Billas Moni Govt.boys School',
      desc: 'Gazipur,Bangladesh',
    },
    { icon: starIcon },
  ];
